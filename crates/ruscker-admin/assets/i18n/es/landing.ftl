...
admin-users-kpi-password-change = Cambio de contraseña pendiente
...
admin-chart-expand = Ampliar gráfico
admin-chart-close = Cerrar
admin-chart-no-data = Aún no hay datos suficientes
admin-chart-access-title = Accesos por día
admin-chart-period-14 = 14 días
admin-chart-period-30 = 30 días
admin-chart-period-90 = 90 días
admin-chart-cpu = CPU
admin-chart-mem = Memoria
admin-chart-window = últimos
...
admin-specs-kpi-active = Activas
admin-specs-kpi-archived = Archivadas
admin-specs-kpi-public = Públicas
admin-specs-kpi-restricted = Restringidas
...
admin-disk-kpi-containers = Contenedores
admin-disk-kpi-stopped = Detenidos
admin-disk-kpi-images = Imágenes
admin-disk-kpi-unused = Imágenes sin uso
admin-disk-kpi-volumes = Volúmenes
...
admin-system-kpi-version = Versión
admin-system-kpi-specs = Aplicaciones
admin-system-kpi-replicas = Réplicas
admin-system-kpi-docker = Docker
admin-system-kpi-db = Base de datos
...
admin-mfa-recovery-regenerated-title = Tus nuevos códigos de recuperación
admin-mfa-recovery-download = Descargar (.txt)
admin-mfa-recovery-copy = Copiar todos
admin-mfa-recovery-copied = Copiado
admin-mfa-recovery-file-header = Ruscker — códigos de recuperación del 2FA
admin-mfa-recovery-file-user = Usuario
admin-mfa-recovery-file-generated = Generado el
admin-mfa-recovery-file-note = Cada código funciona una sola vez. Guarda este archivo en un lugar seguro y elimínalo de carpetas compartidas.
admin-mfa-recovery-remaining = Códigos de recuperación restantes:
admin-mfa-recovery-low = Quedan pocos códigos de recuperación. Genera un nuevo conjunto antes de usar el último.
admin-mfa-recovery-regenerate = Generar nuevos códigos
admin-mfa-recovery-regenerate-help = Los códigos actuales dejan de valer de inmediato. Confirma tu contraseña para generar un nuevo conjunto de 10 códigos.
admin-mfa-recovery-regenerate-confirm = Generar nuevos códigos invalida todos los códigos de recuperación actuales. ¿Continuar?
admin-mfa-error-stale = Esta página estaba desactualizada: los códigos actuales no cambiaron. Recarga e inténtalo de nuevo.
admin-mfa-recovery-copy-failed = No se pudo copiar automáticamente. Selecciona los códigos y cópialos a mano.
