...
admin-mfa-revoke-all = Sair de todos os dispositivos
admin-mfa-revoke-all-confirm = Revogar todas as comprovações de MFA de dispositivos confiáveis da sua conta?
