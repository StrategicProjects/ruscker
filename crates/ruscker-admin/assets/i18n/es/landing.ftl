...
admin-landing-card-cover-default-auto-help = Auto mantiene el tinte por tipo de cada tarjeta; elige un color o degradado para definir una portada predeterminada para todo el catálogo (las tarjetas con su propia portada/acento siguen teniendo prioridad).
