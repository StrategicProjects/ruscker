...
admin-landing-card-cover-default-auto-help = Auto conserve la teinte par type de chaque carte ; choisissez une couleur ou un dégradé pour définir une couverture par défaut pour tout le catalogue (les cartes ayant leur propre couverture/accent gardent la priorité).
