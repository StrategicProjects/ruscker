...
admin-mfa-revoke-all = Déconnecter tous les appareils
admin-mfa-revoke-all-confirm = Révoquer toutes les preuves MFA des appareils approuvés de votre compte ?
