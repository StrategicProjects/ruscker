...
admin-landing-card-cover-default-auto-help = Auto mantém o tom por tipo de cada card; escolha uma cor ou gradiente para definir uma capa padrão para todo o catálogo (cards com capa/destaque próprio continuam mandando).
